...
function render(){
 ...
 const name=userName();
 return `<div class="card"><h2>Willkommen${name?' '+NGT500.esc(name):''}</h2><input placeholder="Tier suchen..." oninput="NGTDashboard.search(this.value)"><div id="searchBox"></div><p class="muted">TerraControl bündelt Bestand, Pflege, Fütterung, Dokumentation und Warnungen.</p></div>${smart}
