...
window.NGTLocales.en={
 ...
 phrases:{
  ...
  'In Bestand':'To collection',
  'Nachzuchten in Bestand':'Move offspring to collection',
  'Diese Nachzucht in den normalen Bestand übernehmen? Alle Daten und Historien bleiben erhalten.':'Move this offspring animal to the regular collection? All data and history will be retained.',
  'Anzahl':'Quantity',
  'Ergebnis':'Result',
