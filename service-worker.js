...
const APP_SHELL=[
  ...
  './v500/core.js'+VERSION_QUERY,'./v500/id-manager.js'+VERSION_QUERY,'./v500/store.js'+VERSION_QUERY,'./v500/ui.js'+VERSION_QUERY,
  ...
  './v500/taxonomy-ui-illustrations.js'+VERSION_QUERY,'./v500/taxonomy-ui-animal-icons.js'+VERSION_QUERY,'./v500/taxonomy-ui-spider-icon.js'+VERSION_QUERY,'./v500/taxonomy-ui-icon-policy.js'+VERSION_QUERY,'./v500/taxonomy-ui-spider-final.js'+VERSION_QUERY,'./v500/taxonomy-ui-tortoise-final.js'+VERSION_QUERY,'./v500/taxonomy-ui-decoration.js'+VERSION_QUERY,'./v500/taxonomy-ui.js'+VERSION_QUERY,'./v500/animal-engine.js'+VERSION_QUERY,
  ...
  './v500/modules/dashboard.js'+VERSION_QUERY,'./v500/hkn-import.js'+VERSION_QUERY,'./v500/modules/animals-core.js'+VERSION_QUERY,'./v500/modules/animals-food.js'+VERSION_QUERY,'./v500/modules/animals-stock.js'+VERSION_QUERY,'./v500/modules/animals-editor.js'+VERSION_QUERY,'./v500/modules/animals.js'+VERSION_QUERY,'./v500/modules/offspring.js'+VERSION_QUERY,
  './v500/modules/profile-core.js'+VERSION_QUERY,'./v500/modules/profile-food.js'+VERSION_QUERY,'./v500/modules/profile-health.js'+VERSION_QUERY,'./v500/modules/profile-passport.js'+VERSION_QUERY,'./v500/modules/profile-photos.js'+VERSION_QUERY,'./v500/modules/profile.js'+VERSION_QUERY,
...
self.addEventListener('fetch',event=>{
 ...
 event.respondWith(fetch(event.request).then(response=>{
  ...
  caches.open(TC_CACHE).then(cache=>cache.put(event.request,copy));
  return response;
 }).catch(()=>caches.match(event.request).then(cached=>cached||caches.match('./v500.html'+VERSION_QUERY))));
});