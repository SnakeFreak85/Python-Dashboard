...
function patchSave(){if(window.__ngtPersistenceSavePatched||typeof window.save!=='function')return;window.__ngtPersistenceSavePatched=true;const old=window.save;window.save=function(){const before=getDb();const r=old.apply(this,arguments);saveDb(window.db||before,'legacy-save');return r;};}
function patchAddAnimal(){if(window.__ngtAddAnimalPatched||typeof window.addAnimal!=='function')return;window.__ngtAddAnimalPatched=true;const old=window.addAnimal;window.addAnimal=function(type){getDb();const r=old.apply(this,arguments);saveDb(window.db||getDb(),'add-animal');if(typeof window.render==='function')window.render();return r;};}
...
function init(){
 load('./v1-data-manager.js?v=1.0.27','data-ngt-data-manager');
